...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const technicienMenuItems: MenuItem[] = [
    {
      label: "Tableau de bord",
    ...
    {
      label: "Calendrier",
      path: "/technicien/calendrier",
      icon: <CalendarIcon />,
    },
    { label: "Mon profil", path: "/technicien/profile", icon: <ProfileIcon /> },
  ];
