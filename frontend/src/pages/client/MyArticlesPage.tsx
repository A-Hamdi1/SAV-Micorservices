          ...
          {articles?.data?.length === 0 ? (
            ...
            <div className="divide-y divide-stroke">
              {articles?.data?.map((article) => (
                <div key={article.id} className="flex items-center justify-between p-5 hover:bg-gray-2 transition-colors">
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-bodydark2">
